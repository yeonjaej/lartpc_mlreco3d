...
cfg = yaml.safe_load(open('/sdf/group/neutrino/yjwa/train/cfgs/grappa_inter_label_restrict_mpr_noweight_val.cfg'))   
...
cfg['trainval']['model_path'] = '/sdf/group/neutrino/yjwa/train/icarus_newk/weights/grappa_inter/label_restrict_mpr_noweight/snapshot-8249.ckpt'
...
with open ('numu_model_test_00_label_restrict_mpr_noweight.csv', 'w') as f:

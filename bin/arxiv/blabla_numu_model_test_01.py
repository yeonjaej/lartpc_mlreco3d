...
cfg['trainval']['model_path'] = '/sdf/group/neutrino/drielsma/me/train/icarus/weights/grappa_inter/label_restrict_nompr/snapshot-8999.ckpt'
...
with open ('numu_model_test_00.csv', 'w') as f:

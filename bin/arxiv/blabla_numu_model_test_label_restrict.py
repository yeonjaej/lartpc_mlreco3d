...
cfg = yaml.safe_load(open('/sdf/group/neutrino/drielsma/me/train/icarus/grappa_inter_label_restrict_val.cfg'))   
...
cfg['trainval']['model_path'] = '/sdf/group/neutrino/drielsma/me/train/icarus/weights/grappa_inter/label_restrict/snapshot-6749.ckpt'
...
with open ('numu_model_test_00_label_restrict.csv', 'w') as f:

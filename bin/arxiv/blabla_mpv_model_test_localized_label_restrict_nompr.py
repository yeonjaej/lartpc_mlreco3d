...
cfg['iotool']['dataset']['data_keys'] = ['/sdf/group/neutrino/ldomine/mpvmpr_112022_v11/all*.root'] # localized mpv
...
with open ('mpv_model_test_00_localized_label_restrict_nompr.csv', 'w') as f:

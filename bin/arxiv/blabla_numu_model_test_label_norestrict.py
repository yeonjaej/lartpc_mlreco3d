...
cfg = yaml.safe_load(open('/sdf/group/neutrino/yjwa/train/cfgs/grappa_inter_label_norestrict_val.cfg'))   
...
cfg['trainval']['model_path'] = '/sdf/group/neutrino/yjwa/train/icarus_newk/weights/grappa_inter/label_norestrict/snapshot-15249.ckpt'
...
with open ('numu_model_test_00_label_norestrict.csv', 'w') as f:

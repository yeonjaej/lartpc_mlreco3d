...
cfg = yaml.safe_load(open('/sdf/group/neutrino/drielsma/me/train/icarus/grappa_inter_label_restrict_n_val.cfg'))   
...
#cfg['trainval']['model_path'] = '/sdf/group/neutrino/drielsma/me/train/icarus/weights/grappa_inter/label_restrict_n/snapshot-11749.ckpt'
cfg['trainval']['model_path'] = '/sdf/group/neutrino/drielsma/me/train/icarus/weights/grappa_inter/label_restrict_n/snapshot-10249.ckpt'
...
with open ('numu_model_test_00_restrict_n.csv', 'w') as f:

...
#cfg = yaml.safe_load(open('/sdf/group/neutrino/drielsma/me/train/icarus/grappa_inter_label_restrict_mpr_val.cfg')) 
cfg = yaml.safe_load(open('/sdf/group/neutrino/drielsma/me/train/icarus_localized/grappa_inter_label_mpr_val.cfg'))
...
#cfg['trainval']['model_path'] = '/sdf/group/neutrino/drielsma/me/train/icarus/weights/grappa_inter/label_restrict_mpr/snapshot-8999.ckpt'
cfg['trainval']['model_path'] = '/sdf/group/neutrino/drielsma/me/train/icarus_localized/weights/grappa_inter/label_mpr/snapshot-98499.ckpt'
...
with open ('numu_model_test_00_localized_label_restrict_mpr.csv', 'w') as f:
